...
description: 主要讲了三级形和速写的练习步骤，答疑补充了一些动线的技巧。
tags: [绘画, 构成]
categories: 绘画
---
# 知识点
...
速写还可以朝着概括去努力，每一笔目的是尽可能明确地区分形状，准确地概括。

事实上，一二三级形是节奏在形状中最直接的一种体现。图形练习时，重点在于大形状、转折处、长宽比。
...
正如 L2 作业，我们就可以利用一二三级形，先画大块形状，再在里面逐渐加小形状。
...
## 速写练习步骤
如果是一个比较完整的速写练习的话，一种常见的步骤如下
1. 用简洁的线段快速抓出整体的动势与走向
2. 在趋势上填充主要的几何图形
3. 赋予立体感

另一种比较推荐的方法是抓剪影，具体步骤差不多
1. 用带压感的笔刷铺出整体剪影和动态趋势
2. 在剪影内部概括出图形
3. 进一步明确结构
...
<figure style="text-align: center; margin-top: 1em;">
  <img src="/illustrations/k大构成L2/4.jpg" alt="两种速写方法" width="80%">
  <figcaption>两种速写方法</figcaption>
</figure>
