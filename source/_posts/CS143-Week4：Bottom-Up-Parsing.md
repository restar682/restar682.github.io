...
### 左因子分解
左因子分解是一种保持语言不变的语法变换，其目的是消除产生式之间的公共左前缀，从而避免自顶向下预测分析中的选择冲突。通过提取公共前缀并将产生式选择推迟到输入符号足够区分的位置，左因子分解减少了 FIRST 集之间的冲突，使语法结构更适合进行 LL(1) 等确定性自顶向下分析，但并不保证语法一定能够转换为 LL(1) 文法。
...
<figure style="text-align: center; margin-top: 1em;">
  <img src="/illustrations/CS143-Week4/3.png" alt="各种 CFG 文法的关系" width="55%">
