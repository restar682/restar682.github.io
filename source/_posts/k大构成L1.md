...
description: 主要讲了趋势的概念和原理，还讲解了积累元素库的方法。
tags: [绘画, 构成]
categories: 绘画
---
# 知识点
...
同样还要考虑直曲对比，比如 CSI。具体来说，在概括人体肌肉的时候，就不能把所有轮廓都处理成原图那样的圆弧，应该寻找隐藏的节点，把圆弧的转折直线化一点，形成对比。
...
然而对整张图去把控它的趋势相当困难，所以我们一般通过练习人物的速写掌握人物的趋势，熟悉之后再拓展到全图。

为了把握趋势线，我们先了解这之中的原理。

因为人的眼睛对于“光滑又流畅”的线的敏感度很高，结合完形理论，这就会让我们产生“很有动态感”的错觉。
...
第一堂课的目的是学习元素的积累。注意我们创作的时候，是根据想要的形状拼贴相应的物体，因此我们要试着去把物体变成形状。有一部分的参考就是告诉你常见元素可以用哪些形状概括，这些适合用来积累图形。
...
当然，并不是所有的参考资料都是形状，也有些资料是骨架、肌肉，对于这种资料就不能只关注形状，要从内部理解形状的来源。

一般来说，两种资料是交错理解的，不过先从形状开始会比较有细心。

接下来是配合动线，也就是说与趋势相结合，这时候就是根据想要的趋势线拼贴相应的形状。为了保证趋势线明显，要增加适合趋势线的平滑长线段。

综合来看，L1 的作业就全面地带我们了解了构成最基本的几个部分，以及从积累到创作的全流程。这看起来无疑是有难度的，我们要在练习中时刻思考知识点的内容，应该能更好地吸收。
...
## 答疑补充
1. 节奏
    大小差距在 $1:0.6$ 的大小差异下，才能被区分出明显大小层级。
